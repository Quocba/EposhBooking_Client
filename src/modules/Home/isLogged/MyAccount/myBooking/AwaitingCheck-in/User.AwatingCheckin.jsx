...
const UserAwatingCheckin = () => {
  ...
  const listbookingCheckin = filterBookingCheckIn(data);

  const bookingsPerPage = 4;
  const indexOfLastBooking = currentPage * bookingsPerPage;
  const indexOfFirstBooking = indexOfLastBooking - bookingsPerPage;
  const currentBooking = listbookingCheckin?.slice(
    indexOfFirstBooking,
    indexOfLastBooking
  );
  const totalPageBooking = Math.ceil(
    listbookingCheckin?.length / bookingsPerPage
  );
...
export default UserAwatingCheckin;
