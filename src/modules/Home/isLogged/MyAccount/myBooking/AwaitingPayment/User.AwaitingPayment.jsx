...
const UserAwaitingPayment = () => {
  ...
  const listbookingPayment = filterBookingPayment(data);

  const bookingsPerPage = 4;
  const indexOfLastBooking = currentPage * bookingsPerPage;
  const indexOfFirstBooking = indexOfLastBooking - bookingsPerPage;
  const currentBooking = listbookingPayment?.slice(
    indexOfFirstBooking,
    indexOfLastBooking
  );
  const totalPageBooking = Math.ceil(
    listbookingPayment?.length / bookingsPerPage
  );
...
export default UserAwaitingPayment;
