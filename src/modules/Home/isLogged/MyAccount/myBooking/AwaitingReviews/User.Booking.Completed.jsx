...
const UserBookingCompleted = () => {
  ...
  const listbookingCompleted = filterBookingCompleted(data);

  const bookingsPerPage = 4;
  const indexOfLastBooking = currentPage * bookingsPerPage;
  const indexOfFirstBooking = indexOfLastBooking - bookingsPerPage;
  const currentBooking = listbookingCompleted?.slice(
    indexOfFirstBooking,
    indexOfLastBooking
  );
  const totalPageBooking = Math.ceil(
    listbookingCompleted?.length / bookingsPerPage
  );
