...
import { filterBookingCheckIn } from "../../../../utils/filter";
...
const AwaitingCheckInBookingPage = () => {
  ...
  const listAwaitingCheckIn = filterBookingCheckIn(data);

  const bookingsPerPage = 10;
  const indexOfLastBooking = currentPage * bookingsPerPage;
  const indexOfFirstBooking = indexOfLastBooking - bookingsPerPage;
  const currentBooking = listAwaitingCheckIn?.slice(
    indexOfFirstBooking,
    indexOfLastBooking
  );
  const totalPageBooking = Math.ceil(
    listAwaitingCheckIn?.length / bookingsPerPage
  );
  ...
  return (
    <>
      ...
      >
        {listAwaitingCheckIn?.length <= 1
          ? `Total Booking: ${listAwaitingCheckIn?.length}`
          : `Total Bookings: ${listAwaitingCheckIn?.length}`}
      </Typography>
...
export default AwaitingCheckInBookingPage;
