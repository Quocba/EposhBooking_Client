...
import AmenitiesModalUpdate from "./Amenities.ModalUpdate";
import {
  formatDate,
  formatDateInput,
  formatPrice,
...
const SpecialPriceModalUpdate = ({
  ...
  const [forms, setForms] = useState(
    data?.specialPrice || [{ startDate: "", endDate: "", price: "" }]
  );
    ...
    <>
      ...
      >
        ...
        <DialogActions sx={{ justifyContent: "space-around" }}>
          ...
          {showNextModal ? (
            <AmenitiesModalUpdate
              data={{
                dataUpdateBasic: data,
                dataUpdateSpecialPrice: forms,
...
export default SpecialPriceModalUpdate;
